...
for (seed in 1:100){
  ...
  set.seed(seed*2024)
  ############
  omics.all <- data_gen_omics(
    n_views = n_views, 
    n_samples = n_samples, 
    n_features = n_features, 
    n_factors = n_factors, 
    likelihood = c('gaussian', 'poisson', 'bernoulli')
  )
  ...
  outfile = file.path(paste0("MOFA_fit/S4/", seed,".hdf5"))
  ...
  fname = paste0('MOFA_fit/S4/Z_', seed, '.RData')
