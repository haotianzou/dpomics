...
fname = paste0('MOFA_fit/S1/Z_', seed, '.RData')
load(fname)

##########Second step
dat <- data_gen_R2C2(seed, tp, N,Z_hat) ##generate longitudinal and survival data
...
fname <- paste0("stan_fit/R2C2/stan_fit_", seed, '.RData',sep="")
...
fname <- paste0("result/R2C2/", seed, '.RData',sep="")
