...
##########Second step
dat <- data_gen_R2C3(seed, tp, N,Z_hat) ##generate longitudinal and survival data
...
fname <- paste0("stan_fit/R2C3/stan_fit_", seed, '.RData',sep="")
...
fname <- paste0("result/R2C3/", seed, '.RData',sep="")
